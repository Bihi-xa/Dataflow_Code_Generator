 ...
 */
std::string parse_command_line_input_function_cpp_rs =
	"#include \"options.h\"\n"
	"#include <string.h>\n"
	"#include <iostream>\n"
	"\n"
...
std::string parse_command_line_input_function_c_rs =
	"#include \"options.h\"\n"
	"#include <stdio.h>\n"
	"#include <string.h>\n"
	"#include <stdlib.h>\n"
...
std::pair<std::string, std::string> generate_ORCC_compatibility_layer_rust(std::string path)
{
	...
	source_file << parse_command_line_input_function_c_rs;
	source_file.close();
